		...
		$(function() {
			$("#fileItem").uploadify({
			    ...
			    'uploader' : '${ctx}/fileupload/uploadifyMutil',//[必须设置]上传文件触发的url
			  	//'formData' : { 'description' : $('#description').val() },//和后台交互时，附加的参数，把参数传给后台，发送给后台的其他参数通过postData指定
			    'height' : 20,//上传按钮的高
			    'width' : 60,//上传按钮的宽
			    ...
			    'fileSizeLimit' : 10485760,//文件的极限大小，以字节为单位，0为不限制。1MB:1*1024*1024
				...
				'onUploadStart' : function(file) {//上传开始时触发（每个文件触发一次）
					//和后台交互时，附加的参数，把参数传给后台，发送给后台的其他参数通过postData指定
					//$("#fileItem").uploadify("settings", "formData", {'description':$("#description").val()});
				},
