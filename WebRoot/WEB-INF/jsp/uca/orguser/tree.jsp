...
<%@ include file="/WEB-INF/jsp/common/js_script_for_base_modules.jsp" %>
    ...
    <script type="text/javascript" src="${ctx}/resources/js/uca/orguser/tree.js"></script>
</head>
<body>
    ...
    <form id="formName_user_jsdw" method="post">
    	...
    	<table>
            ...
            <tr>
                ...
                <td>
                	<select name="userStatus" id="activeSt" class="easyui-combobox" style="width:320px;">
            ...
            <tr>
                ...
                <td>
                	<input name="phoneNum" class="easyui-validatebox" style="width:320px;" 
                		data-options="required:true,missingMessage:'请输入手机!'">
				</td>
            </tr>
            <tr>
                ...
                <td>
                	<input name="telephone" class="easyui-validatebox" style="width:320px;" 
                		data-options="required:false,missingMessage:'请输入联系电话!'">
				</td>
            </tr>
            <tr>
            	<td width="160px" align="right">姓名：</td>
            ...
            <tr>
                ...
                <td>
                	<select name="sex" id="sex" class="easyui-combobox" style="width:320px;">
            ...
            <tr>
                ...
                <td>
                	<input name="email" class="easyui-validatebox" style="width:320px;" 
                		data-options="required:true,missingMessage:'请输入邮箱!'">
				</td>
            </tr>
            <tr>
                ...
                <td>
                	<input name="devOrg" class="easyui-validatebox" style="width:320px;" 
                		data-options="required:true,missingMessage:'请输入建设单位!'">
				</td>
            </tr>
            <tr>
                ...
                <td>
                	<input name="devOrgAddress" class="easyui-validatebox" style="width:320px;" 
                		data-options="required:false,missingMessage:'请输入单位地址!'">
				</td>
            </tr>
            <tr>
            	<td width="160px" align="right">备注：</td>
                <td>
                	<textarea rows="4" cols="30" name="remark" style="width:320px;"></textarea>
				</td>
            </tr>
        </table>
    </form>
...
<div id="user-jsdw-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="javascript:saveJsdwGrid();">保存</a>
