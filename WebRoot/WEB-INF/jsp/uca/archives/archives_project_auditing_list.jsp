...
<title>工程档案待审核列表</title>
<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/style.css" />
<script type="text/javascript" src="${ctx}/resources/js/json.org/json.js"></script>
<script type="text/javascript" src="${ctx}/resources/js/uca/archives/archives_project_auditing_list.js"></script>
</head>
<body>
<input type="hidden" value="${ServerPort}" id="ServerPort_JS"/>
<!-- 搜索 -->
<!-- <div id="select_bar" style="height:25px;padding-bottom: 5px;">
   	<div style="margin: 0 auto;padding: 2px;">
   		<a href="javascript:refreshCurrentPage();" class="easyui-linkbutton">刷新列表</a>
    </div>
</div> -->
<table id="list_data" cellspacing="0" cellpadding="0"></table>

<div id="auditing_dialog" class="easyui-dialog" style="width:500px;height:200px;padding:10px" 
	data-options="closed:true,buttons:'#auditing-buttons',resizable:true,maximizable:true" >
    <form id="formName_auditing">
