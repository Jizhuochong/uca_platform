...
<script type="text/javascript" src="${ctx}/resources/js/uca/archives/archives_schedule_index.js"></script>
</head>
<body>
...
<div id="content" class="defaults">
	<table width="660" class="fore-system-datatab">
		<thead>
			<tr>
				<th width="50%" class="head">调卷单编号</th>
				<th width="30%" class="head">上传时间</th>
				<th width="20%" class="head">复制进度状态</th>
			</tr>
		</thead>
