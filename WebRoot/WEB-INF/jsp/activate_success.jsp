...
<div class="main">
  <div class="box clearfix">
    <div class="tit21"> <span>用户激活</span> </div>
    ...
    <c:choose>
		...
		<div class="mt10"><span class="cRed01" id="seconds">5</span>秒后自动跳转到主页</div>
	 	<div><a href="<c:url value="${registBackurl}"/>" class="cRed01" id="js_login_mail">点击跳转到主页</a></div>
    	</c:when>
    	<c:otherwise>
    	<c:choose>
    		<c:when test="${flag == 2}">
    		...
    		<div class="info"><i> ${msg}</i></div>
			<%-- <div class="mt60"><img src="${ctx}/resources/images/tzjt.gif" /></div> --%>
		 	<div><a href="<c:url value="${registBackurl}"/>" class="cRed01">点击重新激活</a></div>
    		</c:otherwise>
    	</c:choose>
    	</c:otherwise>
    </c:choose>
