...
<!--     <div class="tit21"> <span>用户注册</span> </div> -->
    ...
    <c:choose>
    	<c:when test="${success == true}">
   		<div class="info"><i> 恭喜您！ 注册成功！</i></div>
		<%-- <div class="mt60"><img src="${ctx}/resources/images/tzjt.gif" /></div> --%>
<%-- 		<div class="mt10">邮件已发送到您的邮箱${msg },请进入邮箱并按提示激活用户账户。<input type="hidden" value="${msg }" id="email"/></div> --%>
		<div class="mt10">请等待管理人员审核后登陆！</div>
	 	<div><a href="${ctx}/login.jsp" class="cRed01">返回</a></div>
